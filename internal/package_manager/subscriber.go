...
func NewAppLifecycleSubscriber(packageManagers map[node.Driver]PackageManager, nodeController controller.NodeController) (*hdb.IdempotentStateUpdateSubscriber, error) {
