...
// Source: internal/package_manager/package_manager.go
//
// Generated by this command:
//
//	mockgen -source=internal/package_manager/package_manager.go -package mocks -destination=internal/package_manager/mocks/mock_package_manager.go
//
