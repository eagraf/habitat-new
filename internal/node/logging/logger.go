...
// Implement the fxevent.Logger interface
// Adapted from https://github.com/ipfans/fxlogger
type FxEventLoggerWrapper struct {
	Logger *zerolog.Logger
}

func (l *FxEventLoggerWrapper) LogEvent(event fxevent.Event) {
	switch e := event.(type) {
